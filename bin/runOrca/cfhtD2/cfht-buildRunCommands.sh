...
echo -e "============================\n"
echo "     cd $DATAREL_DIR/pipeline; orca.py -r $DATAREL_DIR/pipeline -e $DATAREL_DIR/bin/runOrca/cfhtD2/cfht-setupForOrcaUse.sh -V 10 -P 10 cfhtD2-orca.paf $1 "
echo -e "============================\n"
