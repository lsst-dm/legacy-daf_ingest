    ...
    for item in schema.asList():
        ...
        if ty in _dbType:
            ...
            if name == "coord":
                ...
                columns.append('@ra')
                columns.append('@decl')
                setexprs.append('coord_ra = @ra')
                setexprs.append('coord_decl = @decl')
                setexprs.append('coord_htmId20 = scisql_s2HtmId(@ra, @decl, 20)')
...
_sourceMappings = [
    ...
    ("{exposurePrefix}_time_range", "timeRange"),
    ...
    ("{measPrefix}flags_badcentroid", "flagBadCentroid"),
    ...
    ("{measPrefix}{psfFlux}_flags", "flagPsfFlux"),
    ("{measPrefix}{apFlux}_flags", "flagApFlux"),
    ("{measPrefix}{modelFlux}_flags", "flagModelFlux"),
    ("{measPrefix}{instFlux}_flags", "flagInstFlux"),
    ("{measPrefix}{centroid}_flags", "flagCentroid"),
    ("{measPrefix}{shape}_flags", "flagShape"),
]
