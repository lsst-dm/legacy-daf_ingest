...
echo -e "============================\n"
echo "     cd $DATAREL_DIR/pipeline; orca.py -r $DATAREL_DIR/pipeline -e $DATAREL_DIR/bin/runOrca/cfht-setupForOrcaUse.sh -V 10 -P 10 cfhtD3-orca.paf $1 "
echo -e "============================\n"
